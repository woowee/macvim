...
# endif
    ...
    {"Perl_hv_iternext_flags", (PERL_PROC*)&Perl_hv_iternext_flags, FALSE},
    {"Perl_hv_iterinit", (PERL_PROC*)&Perl_hv_iterinit, FALSE},
    {"Perl_hv_iterkey", (PERL_PROC*)&Perl_hv_iterkey, FALSE},
    {"Perl_hv_iterval", (PERL_PROC*)&Perl_hv_iterval, FALSE},
    {"Perl_av_fetch", (PERL_PROC*)&Perl_av_fetch, FALSE},
    {"Perl_av_len", (PERL_PROC*)&Perl_av_len, FALSE},
    {"Perl_sv_2nv_flags", (PERL_PROC*)&Perl_sv_2nv_flags, FALSE},
# if defined(PERLIO_LAYERS) && !defined(USE_SFIO)
    {"PerlIOBase_pushed", (PERL_PROC*)&PerlIOBase_pushed, FALSE},
    {"PerlIO_define_layer", (PERL_PROC*)&PerlIO_define_layer, FALSE},
# endif
# if (PERL_REVISION == 5) && (PERL_VERSION >= 24)
